                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Nueva actualizacion en tu pedido en Villarreal Store</h1>

                                                                <strong>Hola: {{$order->recipient_name}}</strong>
                                                                <br>
                                                                Tu pedido ha sido actualizado con la siguiente informacion en Villarreal Store el {{$order->updated_at}}.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; *|2016*|VILLARREAL STORE|*, All rights reserved.</em>
																<br />
																
																
																<strong>Our mailing address is:</strong>
																<br />
																javier.villarreal.623@gmail.com 
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
