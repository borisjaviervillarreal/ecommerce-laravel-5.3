                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Recibo de tu pago en Villarreal Store</h1>

                                                                <strong>Hola: {{$order->recipient_name}}</strong>
                                                                A continuacion te enviamos los datos de tu compra realizada en Villarreal Store el {{$order->created_at}}.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
